...
export const INITIAL_PENGUKURAN_GARDU: PengukuranGardu[] = [
  // GD-PSO-004 Historical Measurements (Aug 2025 -> Feb 2026 showing clear load growth)
  {
    id: 'pkg_1_aug25',
    garduId: 'gd_1',
    noGardu: 'GD-PSO-004',
    ...
    dayaKva: 160,
    alamat: 'Jl. Syaranamual Passo No. 12',
    tanggalUkur: '2025-08-15',
    jamUkur: '10:00 WIT',
    petugas: 'Tim Yantek Passo',
    iRTotal: 98,
    iSTotal: 95,
    iTTotal: 92,
    iNTotal: 8,
    ...
    jurusan1: {
      ...
      iRTotal: 32, iSTotal: 30, iTTotal: 29, iNTotal: 3,
      vRN: 232, vSN: 230, vTN: 231, vRS: 400, vST: 398, vRT: 399,
      iPeakR: 36, iPeakS: 34, iPeakT: 33,
      tpfR: 0.94, tpfS: 0.93, tpfT: 0.94,
      titikUkur: 'PHB-TR Rak 1'
    },
    jurusan2: {
      nama: 'JURUSAN 2 (Komp. Perumahan)',
      iRTotal: 34, iSTotal: 33, iTTotal: 32, iNTotal: 3,
      vRN: 232, vSN: 230, vTN: 231, vRS: 400, vST: 398, vRT: 399,
      iPeakR: 38, iPeakS: 37, iPeakT: 36,
      tpfR: 0.94, tpfS: 0.93, tpfT: 0.94,
      titikUkur: 'PHB-TR Rak 2'
    },
    jurusan3: {
      nama: 'JURUSAN 3 (Pasar Passo)',
      iRTotal: 32, iSTotal: 32, iTTotal: 31, iNTotal: 2,
      vRN: 232, vSN: 230, vTN: 231, vRS: 400, vST: 398, vRT: 399,
      iPeakR: 36, iPeakS: 37, iPeakT: 35,
      tpfR: 0.94, tpfS: 0.93, tpfT: 0.94,
  ...
  },
  {
    ...
    jurusan1: {
      nama: 'JURUSAN 1 (Jl. Raya Passo)',
      iRTotal: 36, iSTotal: 34, iTTotal: 33, iNTotal: 4,
      vRN: 230, vSN: 228, vTN: 229, vRS: 398, vST: 395, vRT: 397,
      iPeakR: 40, iPeakS: 38, iPeakT: 37,
      tpfR: 0.93, tpfS: 0.92, tpfT: 0.93,
      titikUkur: 'PHB-TR Rak 1'
    },
    jurusan2: {
      nama: 'JURUSAN 2 (Komp. Perumahan)',
      iRTotal: 38, iSTotal: 37, iTTotal: 36, iNTotal: 3,
      vRN: 230, vSN: 228, vTN: 229, vRS: 398, vST: 395, vRT: 397,
      iPeakR: 43, iPeakS: 41, iPeakT: 40,
      tpfR: 0.93, tpfS: 0.92, tpfT: 0.93,
      titikUkur: 'PHB-TR Rak 2'
    },
    jurusan3: {
  ...
  },
  {
    ...
    dayaKva: 160,
    alamat: 'Jl. Syaranamual Passo No. 12',
    tanggalUkur: '2025-12-18',
    jamUkur: '19:30 WIT (WBP)',
    petugas: 'Hendrik & Tim Piket',
    iRTotal: 130,
    iSTotal: 125,
    iTTotal: 120,
    iNTotal: 11,
  ...
  // GD-LTR2-015 Historical Measurements (Aug 2025 -> Feb 2026)
  {
    id: 'pkg_2_aug25',
    garduId: 'gd_2',
    noGardu: 'GD-LTR2-015',
  ...
  // GD-WH2-008 Historical Measurements
  {
    id: 'pkg_3_sep25',
    garduId: 'gd_3',
    noGardu: 'GD-WH2-008',
    ...
    dayaKva: 100,
    alamat: 'Jl. Laksda Yos Sudarso Waiheru',
    tanggalUkur: '2025-09-12',
    jamUkur: '10:15 WIT',
    petugas: 'Fandy & Tim Pemeliharaan',
    iRTotal: 72,
    iSTotal: 70,
    iTTotal: 68,
    iNTotal: 6,
  ...
  // GD-TLH-021 Historical Measurements
  {
    id: 'pkg_4_jul25',
    garduId: 'gd_4',
    noGardu: 'GD-TLH-021',
    ...
    dayaKva: 400,
    alamat: 'Jl. Raya Tulehu Pertigaan Pasar',
    tanggalUkur: '2025-07-30',
    jamUkur: '11:00 WIT',
    petugas: 'Tim Yantek Tulehu',
    iRTotal: 280,
    iSTotal: 270,
    iTTotal: 265,
    iNTotal: 18,
  ...
  },
  {
    ...
    dayaKva: 400,
    alamat: 'Jl. Raya Tulehu Pertigaan Pasar',
    tanggalUkur: '2025-12-22',
    jamUkur: '19:00 WIT (WBP)',
    petugas: 'Tim Yantek Tulehu',
    iRTotal: 360,
    iSTotal: 345,
    iTTotal: 340,
...
export const INITIAL_KENDARAAN_OPERASIONAL: KendaraanOperasional[] = [
  {
    ...
    gpsTrack: {
      ...
      altitude: 18,
      batteryLevel: 88,
      statusTrack: 'Penanganan Gangguan',
      lastUpdated: new Date().toISOString(),
      driverName: 'Samuel (Regu A)',
      driverPhone: '081240123456',
      breadcrumbs: [
        { lat: -3.6490, lng: 128.2280, time: '10:00' },
        { lat: -3.6502, lng: 128.2305, time: '10:05' },
        { lat: -3.6515, lng: 128.2325, time: '10:10' }
      ]
    }
  },
  {
    ...
    gpsTrack: {
      ...
      statusTrack: 'Berdiam',
      lastUpdated: new Date().toISOString(),
      driverName: 'Hendra (Pemeliharaan)',
      driverPhone: '081343009988'
    }
  },
  {
    id: 'knd-03',
  ...
  },
  {
    ...
    gpsTrack: {
      ...
      altitude: 15,
      batteryLevel: 79,
      statusTrack: 'Bergerak',
      lastUpdated: new Date().toISOString(),
      driverName: 'Faisal (ROW)',
      driverPhone: '085244112233'
    }
  },
  {
    id: 'knd-05',
    ...
    gpsTrack: {
      ...
      statusTrack: 'Siaga',
      lastUpdated: new Date().toISOString(),
      driverName: 'Tim PDKB Baguala',
      driverPhone: '08114005566'
    }
  }
];
...
export const INITIAL_CHAT_MESSAGES: ChatMessage[] = [
  {
    id: 'msg_init_1',
    senderId: 'usr_owner',
    senderName: 'Sistem ULP Baguala',
    senderUsername: 'owner',
    senderRole: 'Sistem',
    recipient: 'all',
    message: 'Selamat datang di Ruang Obrolan Live Chat ULP Baguala. Gunakan saluran ini untuk koordinasi penanganan gangguan, pemeliharaan, dan survey PB/PD.',
  ...
  },
  {
    ...
    recipient: 'all',
    message: 'Halo Petugas ULP Baguala! Apabila Sistem sedang Offline, AI Bot ini akan membalas pertanyaan dan konsultasi teknis Anda secara otomatis.',
...
export const INITIAL_AUTO_REPLY_RULES: AutoReplyRule[] = [
  {
    id: 'rule_gangguan_1',
    title: 'SOP Penanganan Gangguan Feeder',
    keywords: ['gangguan', 'trip', 'padam', 'feeder', 'blackout'],
    response: '🤖 **[FAQ Otomatis - SOP Gangguan Feeder]**\n1. Catat indikasi relay di Gardu Induk (OCR / GFR / EF).\n2. Koordinasi penelusuran lokasi gangguan bersama tim Yantek.\n3. Input Laporan Gangguan pada menu **"Laporan Gangguan Feeder"** agar waktu pemulihan terhitung di SAIDI/SAIFI.',
    topic: 'gangguan',
    isActive: true,
    createdBy: 'Sistem',
  ...
  {
    id: 'rule_piket_1',
    title: 'Jadwal & Pembagian Shift Piket',
    keywords: ['piket', 'shift', 'jadwal', 'petugas', 'yantek'],
    response: '🤖 **[FAQ Otomatis - Jadwal Piket]**\nJadwal piket Petugas Yantek ULP Baguala terbagi 3 Shift:\n- **Shift 1 (Pagi):** 08.00 - 16.00 WIT\n- **Shift 2 (Siang):** 16.00 - 24.00 WIT\n- **Shift 3 (Malam):** 00.00 - 08.00 WIT\nPerbarui atau cek susunan personel di menu **"Jadwal Piket Petugas"**.',
    topic: 'teknis',
    isActive: true,
    createdBy: 'Sistem',
    createdAt: new Date().toISOString()
