...
export const CustomDropdown: React.FC<CustomDropdownProps> = ({
  ...
  const variantStyles = {
    teal: {
      ...
      hoverItem: 'text-teal-400 hover:bg-teal-900/50 hover:text-white',
    ...
    dark: {
      ...
      hoverItem: 'text-slate-400 hover:bg-slate-800/60 hover:text-white',
    ...
    amber: {
      ...
      hoverItem: 'text-amber-400 hover:bg-amber-950/50 hover:text-white',
    ...
    light: {
      ...
      hoverItem: 'text-slate-600 hover:bg-slate-50 hover:text-slate-900',
